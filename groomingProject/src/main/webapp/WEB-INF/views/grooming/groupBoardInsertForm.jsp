    ...
    <div class="container">
        ...
        <!-- 메인에 들어갈 내용용 -->
            ...
            <div class="container">
                ...
                <form action="groupInsert.do" method="post" enctype="multipart/form-data" id="form">
                    <input type="hidden" name="gMemberNo" value="${gMemberNo}">
                    ...
                    <input type="hidden" name="groomingNo" value="${grooming.groomingNo}">
                        ...
                        <tr>
                            <th>제목: </th>
                            <td><input type="text" placeholder="제목을 입력하세요. " name="gBoardTitle" class="form-control" required></td>
                        </tr>
                        <tr>
                            <th>내용: </th>
                            <td><textarea cols="10" rows="20" placeholder="내용을 입력하세요." id="summernote" name="gBoardContent"
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="button" value="글 목록으로... " onclick="location.href='${gBlist}'">
                            </td>
                        </tr>
                    </form>
