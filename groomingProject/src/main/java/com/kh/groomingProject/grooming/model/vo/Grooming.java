...
public class Grooming implements Serializable{
	...
	private int groomingCount;			// 관리자 페이지에서 쓸 그루밍 카운트
	...
	public Grooming(String groomingNo, String memberNo, String groomingType, String groomingTitle,
			...
			String status, int count, Date groomingNd, int currentP, int groomingCount) {
		this.groomingNo = groomingNo;
		this.memberNo = memberNo;
	...
	public int getGroomingCount() {
		return groomingCount;
	}

	public void setGroomingCount(int groomingCount) {
		this.groomingCount = groomingCount;
	}
	...
	public String toString() {
		return "Grooming [groomingNo=" + groomingNo + ", memberNo=" + memberNo + ", groomingType=" + groomingType
				...
				+ ", count=" + count + ", groomingNd=" + groomingNd + ", currentP=" + currentP + ", groomingCount="
				+ groomingCount + "]";
	}
