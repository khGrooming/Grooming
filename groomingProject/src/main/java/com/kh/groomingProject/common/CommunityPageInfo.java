...
public class CommunityPageInfo implements Serializable{
	/**
	 * 
	 */
	...
	public CommunityPageInfo() {
	}

	public CommunityPageInfo(int currentPage, int listCount, int pageLimit, int maxPage, int startPage, int endPage,
			int boardLimit) {
