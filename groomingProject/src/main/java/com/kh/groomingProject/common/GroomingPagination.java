...
public class GroomingPagination {
	public static GroomingPageInfo getPageInfoG(int currentPage, int listCount,int boardLimit) {
	...
	public static GroomingPageInfo getPageInfoM(int currentPage, int listCount) {
		GroomingPageInfo pi = null;
