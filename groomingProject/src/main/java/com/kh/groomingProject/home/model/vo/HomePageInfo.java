...
public class HomePageInfo implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6441652456850154630L;
	...
	public HomePageInfo(int currentPage, int listCount, int pageLimit, int maxPage, int startPage, int endPage,
			int boardLimit) {
		super();
