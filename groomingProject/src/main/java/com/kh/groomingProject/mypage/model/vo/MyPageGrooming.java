...
public class MyPageGrooming implements Serializable{
	...
	public MyPageGrooming(String gMemberNo, String groomingNo, String groomingType, String groomingImg,
			String groomingTitle, String groomingIntroduce, Date groomingNd, Date groomingEd) {
		super();
	...
	public String toString() {
		return "MyPageGrooming [gMemberNo=" + gMemberNo + ", groomingNo=" + groomingNo + ", groomingType="
				+ groomingType + ", groomingImg=" + groomingImg + ", groomingTitle=" + groomingTitle
				+ ", groomingIntroduce=" + groomingIntroduce + ", groomingNd=" + groomingNd + ", groomingEd="
				+ groomingEd + "]";
	}
